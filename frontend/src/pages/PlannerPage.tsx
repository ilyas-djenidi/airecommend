            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex item-center gap-2">
                    <Input
                        ...
                        className="w-auto"
                    />
                    <Button onClick={runPlanner} disabled={store.zones.length === 0 || loading}>
            ...
            <div className="space-y-4">
                {plans.map((day, idx) => (
                    <Card key={day.date} className="p-0 overflow-hidden">
                        <div
                            className="p-4 bg-slate-50 border-b flex justify-between items-center cursor-pointer hover:bg-slate-100"
                        ...
                        >
                            ...
                            <div className="text-sm text-slate-500">
                                {day.decisions.filter(d => d.action !== 'SKIP').length} Zones Serviced
                            </div>
                        </div>
